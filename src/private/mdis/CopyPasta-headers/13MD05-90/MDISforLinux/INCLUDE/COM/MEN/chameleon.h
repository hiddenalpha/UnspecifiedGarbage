...
#define CHAMELEON_16Z087_ETH	    	0x46    /* New duagon Ethernet Core */
...
typedef struct {
	...
	u_int16 devId;				/*!< device id of unit (last three digit of the
                                     duagon-article name, e.g. 044 for 16Z044_DISP) */
