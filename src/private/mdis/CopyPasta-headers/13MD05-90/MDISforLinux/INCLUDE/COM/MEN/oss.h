...
#define OSS_PCI_ADDR_SIZE_0         (OSS_PCI_ADDR_0 + OSS_PCI_SIZE_MAGIC)
#define OSS_PCI_ADDR_SIZE_1         (OSS_PCI_ADDR_1 + OSS_PCI_SIZE_MAGIC)
#define OSS_PCI_ADDR_SIZE_2         (OSS_PCI_ADDR_2 + OSS_PCI_SIZE_MAGIC)
#define OSS_PCI_ADDR_SIZE_3         (OSS_PCI_ADDR_3 + OSS_PCI_SIZE_MAGIC)
#define OSS_PCI_ADDR_SIZE_4         (OSS_PCI_ADDR_4 + OSS_PCI_SIZE_MAGIC)
#define OSS_PCI_ADDR_SIZE_5         (OSS_PCI_ADDR_5 + OSS_PCI_SIZE_MAGIC)
...
#else
	/* swap macros */
    #define OSS_SWAP16(word)   ( (((u_int16)(word)>>8) & 0x00ffu) | \
                                 (((u_int16)(word)<<8) & 0xff00u) )

    #define OSS_SWAP32(dword)  ( (((u_int32)(dword)>>24) & 0x000000ffu)   | \
                                 (((u_int32)(dword)<<24) & 0xff000000u)   | \
                                 (((u_int32)(dword)>>8)  & 0x0000ff00u)   | \
                                 (((u_int32)(dword)<<8)  & 0x00ff0000u) )

    #define OSS_SWAP64(qword)  ( ((u_int64)(qword>>56) & 0x00000000000000ffLLu) | \
                                 ((u_int64)(qword<<56) & 0xff00000000000000LLu) | \
                                 ((u_int64)(qword>>40) & 0x000000000000ff00LLu) | \
                                 ((u_int64)(qword<<40) & 0x00ff000000000000LLu) | \
                                 ((u_int64)(qword>>24) & 0x0000000000ff0000LLu) | \
                                 ((u_int64)(qword<<24) & 0x0000ff0000000000LLu) | \
                                 ((u_int64)(qword>>8)  & 0x00000000ff000000LLu) | \
                                 ((u_int64)(qword<<8)  & 0x000000ff00000000LLu) )
#endif
