 ...
 *      \author  uf
 *
 *     \project  duagon global
 *       \brief  duagon types and useful definitions
 *    \switches  WINNT
 *               OS9
 *               MSDOS
 *               LYNX
...
/* Modular API calling convention and 64-bit support */
#if defined(WINNT)
  /* 64-bit compiler */
  #if defined(_WIN64)
#define __MAPILIB						/**< Modular API calling convention */
  ...
  /* 32-bit compiler */
  #else
    #define __MAPILIB 		__stdcall	/**< Modular API calling convention */
